...
Meshtatic is supported. By default all topic starting with `mesh/` will be identified and parsed as Meshtatic messages. It can be changed using `MESHTATIC_TOPIC_PREFIX` environment variable.
